...
export const updateProfile = catchAsyncErrors(async (req, res, next) => {
  ...
  if (req.files && req.files.avatar) {      //if avatar hota hai to usko distroy kardo 
...
export const updatePassword = catchAsyncErrors(async (req, res, next) => {
  const { currentPassword, newPassword, confirmNewPassword } = req.body;     //using destructing
...
// ----------------getUserWithoutUsingAuthenticaiton---------
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "672b47ec419af902992f22a7";
